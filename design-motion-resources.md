...
| 7 | Refero Styles | https://styles.refero.design/?sort=popular | 2000+ 高质量 DESIGN.md 设计系统示例，收录 Linear、Stripe、Cursor 等知名产品网站的可读设计规范（色彩、字体、间距、组件），可直接用于 Cursor / Claude Code / Codex / v0 / Lovable 等 AI 工具；另提供 Refero MCP 供 agent 检索真实产品界面 |
